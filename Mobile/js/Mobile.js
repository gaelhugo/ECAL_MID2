...
Mobile.prototype = {
  ...
  onstart:function(e){
    this.sendMessage([e.touches[0].pageX,e.touches[0].pageY],this.ID,"controllerStart");
  ...
  ontouch:function(e){
    ...
    this.sendMessage([e.touches[0].pageX,e.touches[0].pageY],this.ID,"controllerMove");
  },

  onend:function(e){

    this.sendMessage([e.changedTouches[0].pageX,e.changedTouches[0].pageY],this.ID,"controllerEnd");
